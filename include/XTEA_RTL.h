#ifndef WATERTANK_SYSTEM_XTEA_RTL_H
#define WATERTANK_SYSTEM_XTEA_RTL_H
...
SC_MODULE(XTEA_RTL) {
  ...
  sc_in<bool> input_ready; // Flag for telling input is ready
  sc_out<bool> output_ready; // Flag for telling output is ready
...
#endif // WATERTANK_SYSTEM_XTEA_RTL_H
